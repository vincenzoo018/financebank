-- ============================================================================
-- FINEBANK ACCOUNTING & FINANCE SCHEMA - PART 2
-- Accounting Operations & Finance Operations
-- ============================================================================
...
-- ============================================================================
-- SECTION 8: ACCOUNTING OPERATIONS (ACCOUNTANT)
-- ============================================================================
...
-- Journal Entries: Records all accounting transactions
...
-- Trial Balance: Balance of all accounts at a specific date
...
(
    ...
    [StatementType]        NVARCHAR(50)      NOT NULL,  -- IncomeStatement, BalanceSheet, CashFlow
    [StatementDate]        DATE              NOT NULL,
    [PeriodStart]          DATE              NOT NULL,
    [PeriodEnd]            DATE              NOT NULL,
    [Content]              NVARCHAR(MAX)     NULL,  -- JSON format
    [CreatedByEmployeeId]  INT               NOT NULL,
    [ApprovedByEmployeeId] INT               NULL,
...
-- Accounting Reports: Various accounting reports
...
(
    ...
    [ReportType]         NVARCHAR(50)      NOT NULL,  -- JournalReport, LedgerReport, TrialBalanceReport
    [ReportDate]         DATE              NOT NULL,
    [PeriodStart]        DATE              NOT NULL,
    [PeriodEnd]          DATE              NOT NULL,
    [Content]            NVARCHAR(MAX)     NULL,  -- JSON or HTML
    [CreatedByEmployeeId] INT              NOT NULL,
...
-- ============================================================================
-- SECTION 9: FINANCE OPERATIONS (FINANCE MANAGER)
-- ============================================================================
...
-- Financial Forecasting: Forecast future cash flows and expenses
...
(
    ...
    [Accuracy]            DECIMAL(9,2)      NULL,  -- Percentage
    [Description]         NVARCHAR(250)     NULL,
    [CreatedByEmployeeId] INT               NOT NULL,
...
-- Finance Reports: Various finance reports
CREATE TABLE [FinanceReports]
(
    [FinanceReportId]   BIGINT IDENTITY(1,1) NOT NULL CONSTRAINT PK_FinanceReports PRIMARY KEY,
    [ReportName]        NVARCHAR(150)     NOT NULL,
    [ReportType]        NVARCHAR(50)      NOT NULL,  -- APReport, ARReport, BudgetReport, CashFlowReport, ForecastReport
    [ReportDate]        DATE              NOT NULL,
    [PeriodStart]       DATE              NOT NULL,
    [PeriodEnd]         DATE              NOT NULL,
    [Content]           NVARCHAR(MAX)     NULL,  -- JSON or HTML
...
-- ============================================================================
-- END OF FINEBANK ACCOUNTING & FINANCE SCHEMA
-- ============================================================================
