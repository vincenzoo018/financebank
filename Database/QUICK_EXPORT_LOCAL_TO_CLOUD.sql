-- =============================================
-- QUICK DATA EXPORT: LOCAL TO CLOUD
-- =============================================
-- 
-- Instructions:
-- 1. Connect SSMS to LOCAL: localhost\SQLEXPRESS -> BFASdatabase
-- 2. Run this script to get INSERT statements
-- 3. Copy the results
-- 4. Connect SSMS to CLOUD: db34283.public.databaseasp.net,1433 -> db34283
...
PRINT '-- =========================================='
PRINT '-- SYNC COMPLETE'
PRINT '-- Copy all statements above and run on CLOUD'
PRINT '-- =========================================='
